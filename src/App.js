...
function App() {
  ...
  return (
    <div className='App'>
      <Cart product={products} setProduct={setProducts} count={counts} setCount={setCounts} />

      <ShoppingCart product={products} setProduct={setProducts} count={counts} setCount={setCounts} />
